                ...
                <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.name ? 'border-red-500 bg-red-50/50 ring-2 ring-red-500/10' : 'border-slate-200'} focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/20 outline-none transition-all`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.email ? 'border-red-500 bg-red-50/50 ring-2 ring-red-500/10' : 'border-slate-200'} focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/20 outline-none transition-all`}
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.phone ? 'border-red-500 bg-red-50/50 ring-2 ring-red-500/10' : 'border-slate-200'} focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/20 outline-none transition-all`}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full px-4 py-3 rounded-xl border ${errors.message ? 'border-red-500 bg-red-50/50 ring-2 ring-red-500/10' : 'border-slate-200'} focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/20 outline-none transition-all resize-none`}
